...
function buildHeader()
{
    ...
    if (showGlitch)
    {
        ...
        glitchBtn.setAttribute('aria-label', glitchDisabled ? 'Enable glitch effect' : 'Disable glitch effect');
        glitchBtn.setAttribute('title',      glitchDisabled ? 'Enable glitch effect' : 'Disable glitch effect');
